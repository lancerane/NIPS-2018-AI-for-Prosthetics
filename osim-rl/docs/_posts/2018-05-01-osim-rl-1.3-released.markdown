...
Due to the errors described in [https://github.com/stanfordnmbl/osim-rl/issues/31](https://github.com/stanfordnmbl/osim-rl/issues/31) we updated the environment
